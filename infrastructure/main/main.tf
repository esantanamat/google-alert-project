...
resource "aws_sfn_state_machine" "arrival_time_notifier_sm" {
  ...
  definition = jsonencode({
    ...
    States = {
      ...
      FetchGoogleAPI = {
        Type       = "Task",
        Resource   = aws_lambda_function.google_api_function.arn, 
        Next       = "SendEmail",
...
resource "aws_cloudwatch_event_target" "step_function_target" {
  ...
  role_arn  = aws_iam_role.eventbridge_stepfn_invoker.arn
}
...
resource "aws_iam_role" "eventbridge_stepfn_invoker" {
  name = "eventbridge-stepfn-invoker"
...
resource "aws_iam_role_policy" "eventbridge_stepfn_policy" {
  ...
  role = aws_iam_role.eventbridge_stepfn_invoker.id
